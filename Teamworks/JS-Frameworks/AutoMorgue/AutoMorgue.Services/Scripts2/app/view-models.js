...
window.vmFactory = (function () {
        ...
        return data.categories.all()
			.then(function (data) {
			    var viewModel = {
			        ...
			        location: function (ev) {
			            var target = $(ev.currentTarget);
			            var cat = target.context.id;
			            window.location.href = "#/auto-parts/cat/" + cat;
			        }
			    };
    ...
    function getPartsByCatViewModel(cat) {
        return data.parts.byCat(cat)
          .then(function (data) {
              var viewModel = {
                  parts: data,
                  getPerticularPart: function (ev) {
    ...
    return {
        ...
        getPartsByCatVM: getPartsByCatViewModel,
